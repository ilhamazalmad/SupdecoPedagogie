...
public class EtudiantAnnee {
	...
	public EtudiantAnnee(int idEtudiantAnnee, boolean depart, Date dateDepart, Collection<Controle> controle,
			Collection<Examen> examen, Collection<Rachetage> rachetage, Collection<Numerotation> numerotation) {
		super();
